  ...
  return (
    <section className='home' id='home'>
        ...
        <div className="home__container container">
            ...
            <h1 className="home__title text-cs"><span>Enyew </span></h1>
            ...
            <p className="home__text">From Ethiopia, I am experienced software Engineer and I am full stack developer</p>
